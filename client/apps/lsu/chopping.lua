...
local _delay = false
local _vehBones = {
	{ name = "wheel_lf", distance = 1.2, index = 0, type = "tire", duration = 3000 },
	{ name = "wheel_rf", distance = 1.2, index = 1, type = "tire", duration = 3000 },
	{ name = "wheel_lm", distance = 1.2, index = 2, type = "tire", duration = 3000 },
	{ name = "wheel_rm", distance = 1.2, index = 3, type = "tire", duration = 3000 },
	{ name = "wheel_lr", distance = 1.2, index = 4, type = "tire", duration = 3000 },
	{ name = "wheel_rr", distance = 1.2, index = 5, type = "tire", duration = 3000 },
	{ name = "wheel_lm1", distance = 1.2, index = 2, type = "tire", duration = 3000 },
	{ name = "wheel_rm1", distance = 1.2, index = 3, type = "tire", duration = 3000 },
	{ name = "door_dside_f", distance = 1.2, index = 0, type = "door", duration = 6000 },
	{ name = "door_pside_f", distance = 1.2, index = 1, type = "door", duration = 6000 },
	{ name = "door_dside_r", distance = 1.2, index = 2, type = "door", duration = 6000 },
	{ name = "door_pside_r", distance = 1.2, index = 3, type = "door", duration = 6000 },
	{ name = "bonnet", distance = 1.4, index = 4, type = "door", duration = 9000 },
	{ name = "boot", distance = 1.2, index = 5, type = "door", duration = 9000 },
}
